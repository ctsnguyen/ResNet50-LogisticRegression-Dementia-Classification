...
- After you mount the drive paths and the dataset path according to where you downloaded the OASIS-1 and OASIS-2 dataset, you should be able to Run All in colab for the ResNet50, LogisticRegression, and the Fusion model notebooks.
